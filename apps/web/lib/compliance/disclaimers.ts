...
export const DISCLAIMERS = {
  ...
  emergency: {
    en: "You've described something that may require immediate medical attention. If you're experiencing a medical emergency, please call 911. For mental health crises, call 988.",
    zh: "您描述的情况可能需要立即就医。如遇紧急情况，请拨打 911。心理健康危机请拨打 988。",
  },
} as const;
